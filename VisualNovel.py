...
def draw_box(screenname,x,y,width,height,color1=(255,255,255),color2 = (0,0,0)):
    '''This function draws a borderless box'''
...
def draw_button(screenname,x,y,width,height,color1=(255,255,255),color2 = (0,0,0)):
    '''this function draws a box with a border that serves as a button'''
...
def textbox (screenname,fontname,fontsize,text,colors,x,y):
    '''This function allows easier input of text in the file'''
    default_font = pygame.font.Font(fontname,fontsize)
    screenname.blit(default_font.render(text,1,colors),(x,y))
def start_ending():
    '''this function activates when the ending occurs, letting the player to return to main menu'''
    screen_width = 1280
    screen_height = 720
    ...
    while not done:
        ...
        for event in pygame.event.get():
            if event.type == pygame.MOUSEBUTTONDOWN and (mouse_position[0]>1100 and mouse_position[0]<1220) and (mouse_position[1]>650 and mouse_position[1]<690):
                ...
                start_menu()
def start_shop():
    '''this function initializes the shop and allows the player to buy items'''
    ...
    while not done:
        ...
        for event in pygame.event.get():
            if event.type == pygame.MOUSEBUTTONDOWN and (mouse_position[0]>1100 and mouse_position[0]<1220) and (mouse_position[1]>650 and mouse_position[1]<690):
                ...
                error_msg = 0
def start_menu():
    '''this function activates the initialiation screen of the game, the main menu, and allows the loading of saved files'''
...
class scene():
    '''this class refers to a new scene added to the game'''
    def __init__(self):
    ...
    def ins_decision(self,line,choices,fontsize,xcoordinate):
        '''this function allows the input of decisions on certain lines'''
        self.choices.append([line,choices,fontsize,xcoordinate])
    def bg_img(self,filename):
        '''this function changes the background of the scene'''
        self.bg = filename
    def ins_script(self,filename):
        '''this function loads .txt files to serve as the game's script'''
    ...
    def ins_sprite(self, filename, firstline, lastline,x,y,width,height):
        '''this function allows the input of character sprites on certain lines'''
        sprite_info = [filename,firstline,lastline,x,y,width,height]
        self.sprites.append(sprite_info)
    def ins_audio(self,filename):
        '''this function allows the input of audio files to serve as background music'''
        self.bgm = filename
    def run_scene(self,font,fontsize):
        '''this function takes care of everything that happens on the scene, including the user interaction with the game'''
        global asterios_killed
        global yorjan_chosen
        global what_scene
        global current_line
        ...
        while not done:
            ...
            for event in pygame.event.get():
                if event.type == pygame.MOUSEBUTTONDOWN and self.decision_on == 0 and (mouse_position[0]>=40 and mouse_position[0]<=1230) and (mouse_position[1]>=550 and mouse_position[1]<=670):
                    ...
                    if len(what_scene) == 1:
                        what_scene = str(int(what_scene[0])+1) + 'a'
                    elif not str(what_scene[1]).isdigit():
                    ...
                    if len(what_scene) == 1:
                        what_scene = str(int(what_scene[0])+1) + 'b'
                    elif not str(what_scene[1]).isdigit():
...
def main():
    ...
    lanaya_chosen = 0
    yorjan_chosen = 0
    asterios_killed = 0 #parameter for an ending
    final_yorjan_chosen = 0 #parameter for best ending
    ...
    while what_scene != '1':
        ...
        if what_scene == '2':
            ...
            scene12 = scene()
            scene12.bg_img('old_town_by_kotnonekot_d55s99y-fullview.jpg')
            if doll_purchased:    
                ...
                scene12.ins_decision(24,['Follow the Chupacabras','Listen to Claude'],30,[510,520])
            else:
            ...
            scene12a = scene()
            scene12a.bg_img('old_town_by_kotnonekot_d55s99y-fullview.jpg')
            ...
            scene12b = scene()
            scene12b.bg_img('old_town_by_kotnonekot_d55s99y-fullview.jpg')
            ...
            scene14a = scene()
            yorjan_chosen+=1
            scene14a.bg_img('Level_test.jpg')
            if lanaya_chosen>0:
            ...
            scene14b = scene()
            lanaya_chosen+=1
            scene14b.bg_img('Level_test.jpg')
            if lanaya_chosen>=2:
            ...
            asterios_killed = True
            scene15a = scene()
            scene15a.bg_img('1.jpg')
            if lanaya_chosen>=2:
            ...
            scene16 = scene()
            scene16.bg_img('d5bac5d3433d15c1a224a0d59b77bdfa.jpg')
            ...
            final_yorjan_chosen = 1
            scene16a = scene()
            scene16a.bg_img('d5bac5d3433d15c1a224a0d59b77bdfa.jpg')
            ...
            scene16b = scene()
            scene16b.bg_img('d5bac5d3433d15c1a224a0d59b77bdfa.jpg')
            ...
            scene17 = scene()
            scene17.bg_img('d5bac5d3433d15c1a224a0d59b77bdfa.jpg')
            ...
            scene18 = scene()
            scene18.bg_img('underground_by_jordangrimmer_d9uj0ml-pre.jpg')
            scene18.ins_script('scene18.txt')
            scene18.ins_sprite('Klaus.png',1,1,250,80,900,1160)
            scene18.ins_sprite('Klaus.png',4,4,250,80,900,1160)
            scene18.ins_sprite('Klaus.png',7,7,250,80,900,1160)
            scene18.ins_sprite('Klaus.png',8,8,250,80,900,1160)
            scene18.ins_audio('Made in Abyss OST - Tomorrow.mp3')
            scene18.run_scene('Futura Book font.ttf',23)
        elif what_scene == '28':
            if lanaya_chosen < 2 and info_purchased: #worst end
                scene20 = scene()
                scene20.bg_img('underground_by_jordangrimmer_d9uj0ml-pre.jpg')
                scene20.ins_script('scene20.txt')
                scene20.ins_sprite('Klaus.png.',2,2,250,80,900,1160)
                scene20.ins_sprite('Klaus.png.',5,5,250,80,900,1160)
                scene20.ins_audio('Mysterious Psychological Horror Music - Dukkha.mp3')
                scene20.run_scene('Futura Book font.ttf',23)
            elif lanaya_chosen < 2 and not info_purchased: #bad end
                scene19 = scene()
                scene19.bg_img('underground_by_jordangrimmer_d9uj0ml-pre.jpg')
                ...
                scene19.ins_audio('Mysterious Psychological Horror Music - Dukkha.mp3')
                scene19.run_scene('Futura Book font.ttf',23)
            elif yorjan_chosen < 1: #bad end
                scene21 = scene()
                scene21.bg_img('underground_by_jordangrimmer_d9uj0ml-pre.jpg')
                ...
                scene21.ins_audio('Mysterious Psychological Horror Music - Dukkha.mp3')
                scene21.run_scene('Futura Book font.ttf',23)
            elif yorjan_chosen == 1 and final_yorjan_chosen: #best end
                scene24 = scene()
                scene24.bg_img('underground_by_jordangrimmer_d9uj0ml-pre.jpg')
                scene24.ins_script('scene24.txt')
                scene24.ins_sprite('Klaus.png',2,2,250,80,900,1160)
                scene24.ins_sprite('Yorjan Talking.png.png', 4, 4, 600, 60, 690, 680)
                scene24.ins_sprite('Klaus.png',5,5,250,80,900,1160)
                scene24.ins_sprite('Lanaya Talking.png.png', 6, 6, 400, 80, 552, 560)
                scene24.ins_sprite('Yorjan Talking.png.png', 7, 7, 600, 60, 690, 680)
                scene24.ins_sprite('Klaus.png',8,8,250,80,900,1160)
                scene24.ins_sprite('Klaus.png',12,12,250,80,900,1160)
                ...
                scene24.ins_sprite('Klaus.png',19,19,250,80,900,1160)
                ...
                scene24.ins_sprite('Klaus.png',25,25,250,80,900,1160)
                scene24.ins_sprite('Lanaya Angry.png.png', 26, 26, 400, 80, 552, 560)
                scene24.ins_sprite('Klaus.png',27,27,250,80,900,1160)
                scene24.ins_sprite('Klaus.png',28,28,250,80,900,1160)
                ...
                scene24.ins_sprite('Klaus.png',34,34,250,80,900,1160)
                scene24.ins_sprite('Klaus.png',36,36,250,80,900,1160)
                ...
                scene24.ins_audio('Most Emotional Music Ever Forever by Tracey Chattaway.mp3')
                scene24.run_scene('Futura Book font.ttf',23)
            elif yorjan_chosen == lanaya_chosen: #neutral end
                scene22 = scene()
                scene22.bg_img('underground_by_jordangrimmer_d9uj0ml-pre.jpg')
                scene22.ins_script('scene22.txt')
                scene22.ins_sprite('Klaus.png',3,3,250,80,900,1160)
                scene22.ins_sprite('Klaus.png',5,5,250,80,900,1160)
                ...
                scene22.ins_sprite('Klaus.png',18,18,250,80,900,1160)
                scene22.ins_sprite('Klaus.png',20,20,250,80,900,1160)
                scene22.ins_sprite('Klaus.png',24,24,250,80,900,1160)
                ...
                scene22.ins_audio('Most Emotional Music Ever Forever by Tracey Chattaway.mp3')
                scene22.run_scene('Futura Book font.ttf',23)
            elif doll_purchased: #bonus end
                scene25 = scene()
                scene25.bg_img('underground_by_jordangrimmer_d9uj0ml-pre.jpg')
                scene25.ins_script('scene25.txt')
                scene25.ins_sprite('Klaus.png',2,2,250,80,900,1160)
                scene25.ins_sprite('Claude Resurrected Angry.png.png',3,3,380,30,600,700)
                ...
                scene25.ins_sprite('Claude Resurrected.png.png',13,13,380,30,600,700)
                scene25.ins_sprite('Klaus.png',16,16,250,80,900,1160)
                scene25.ins_sprite('Klaus.png',19,21,250,80,900,1160)
                scene25.ins_audio('Most Emotional Music Ever Forever by Tracey Chattaway.mp3')
                scene25.run_scene('Futura Book font.ttf',23)
            else: #good end
                scene23 = scene()
                scene23.bg_img('underground_by_jordangrimmer_d9uj0ml-pre.jpg')
                ...
                scene23.ins_audio('Most Emotional Music Ever Forever by Tracey Chattaway.mp3')
